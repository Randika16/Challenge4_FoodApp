...
class CartAdapter(private val cartList: List<CartEntity>, private val context: Context) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.foodImage.setImageResource(cart.foodItem.image)
        ...
        holder.minusButton.setOnClickListener {
            ...
            holder.cartFoodPrice.text = (cart.foodQuantity * cart.foodItem.price.toDouble()).toCurrencyFormat()
        }
        ...
        holder.noteField.setOnFocusChangeListener { _, hasFocus ->
            if (!hasFocus) {
                onItemClickCallback.onNotesChanged(cartList[holder.adapterPosition], holder.noteField.text.toString())
            }
        }
    }
